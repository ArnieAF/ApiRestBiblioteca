...
-- USUARIOS
INSERT INTO Usuario (nombre, email, fecha_registro) VALUES ('Arnie Adriano', 'arnie@example.com', '2026-01-10T09:00:00');
INSERT INTO Usuario (nombre, email, fecha_registro) VALUES ('Ana Torres', 'ana@example.com', '2026-02-15T10:30:00');
INSERT INTO Usuario (nombre, email, fecha_registro) VALUES ('Luis Fernández', 'luis@example.com', '2026-03-20T14:00:00');

-- LIBROS (id_autor referencia el orden de inserción de arriba: 1=García Márquez, 2=Allende, 3=Borges, 4=Vargas Llosa, 5=Rowling)
...
-- RESERVAS (id_libro y id_usuario referencian el orden de inserción de arriba)
...
INSERT INTO Reserva (fecha_reserva, fecha_expiracion, id_libro, id_usuario) VALUES ('2026-07-01T15:00:00', '2026-07-15T15:00:00', 7, 1); 1, 3);